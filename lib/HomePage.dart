  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: Colors.orange, // Orange for selected bottom tab
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      // Menu Icon with Orange Highlight
                      Container(
                        height: 40,
                        width: 40,
                ...
                // Categories Row (Active Category in Orange)

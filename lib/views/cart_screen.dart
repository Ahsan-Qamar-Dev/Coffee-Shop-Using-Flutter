...
import 'package:my_coffee_shop/views/payment_screen.dart';
...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final innerColor = isDark ? const Color(0xFF14181F) : Colors.grey.shade100;
                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            LightText(
                              text:
                                  "Explore our delicious coffees and add items!",
                              size: 14,
                              color: Colors.grey,
                            ),
                          ],
